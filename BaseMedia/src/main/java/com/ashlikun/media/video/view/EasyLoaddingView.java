...
public class EasyLoaddingView extends View {
    ...
    public EasyLoaddingView(Context context) {
        super(context);
    }

    public EasyLoaddingView(Context context, AttributeSet attrs) {
        super(context, attrs);

        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.EasyLoaddingView);
        int lineColor = ta.getColor(R.styleable.EasyLoaddingView_loadding_line_color, DEFAULT_LINE_COLOR);
        int bgLineColor = ta.getColor(R.styleable.EasyLoaddingView_loadding_bg_line_color, DEFAULT_BG_LINE_COLOR);
        int textColor = ta.getColor(R.styleable.EasyLoaddingView_loadding_text_color, DEFAULT_TEXT_COLOR);
        int lineWidth = ta.getDimensionPixelSize(R.styleable.EasyLoaddingView_loadding_line_width, VideoUtils.dip2px(getContext(), DEFAULT_LINE_WIDTH));
        int bgLineWidth = ta.getDimensionPixelSize(R.styleable.EasyLoaddingView_loadding_bg_line_width, VideoUtils.dip2px(getContext(), DEFAULT_BG_LINE_WIDTH));
        int textSize = ta.getDimensionPixelSize(R.styleable.EasyLoaddingView_loadding_text_size, VideoUtils.dip2px(getContext(), DEFAULT_TEXT_SIZE));
        ta.recycle();
